...
public class ComponentVillageDuneField2 extends ComponentVillageDune
{
    private int averageGroundLevel = -1;

    public ComponentVillageDuneField2(ComponentVillageStartPieceDune par1ComponentVillageStartPieceDune, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public static ComponentVillageDuneField2 func_74902_a(ComponentVillageStartPieceDune par0ComponentVillageStartPieceDune, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(par3, par4, par5, 0, 0, 0, 7, 4, 9, par6);
        return canVillageGoDeeper(var8) && StructureComponent.findIntersecting(par1List, var8) == null ? new ComponentVillageDuneField2(par0ComponentVillageStartPieceDune, par7, par2Random, var8, par6) : null;
    }
