...
public class ComponentVillageDuneHouse2 extends ComponentVillageDune
{
    ...
    public static ComponentVillageDuneHouse2 func_74915_a(ComponentVillageStartPieceDune par0ComponentVillageStartPieceDune, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(par3, par4, par5, 0, 0, 0, 10, 6, 7, par6);
        return canVillageGoDeeper(var8) && StructureComponent.findIntersecting(par1List, var8) == null ? new ComponentVillageDuneHouse2(par0ComponentVillageStartPieceDune, par7, par2Random, var8, par6) : null;
    }
