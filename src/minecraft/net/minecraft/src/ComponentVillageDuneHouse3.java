...
public class ComponentVillageDuneHouse3 extends ComponentVillageDune
{
    private int averageGroundLevel = -1;

    public ComponentVillageDuneHouse3(ComponentVillageStartPieceDune par1ComponentVillageStartPieceDune, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public static ComponentVillageDuneHouse3 func_74921_a(ComponentVillageStartPieceDune par0ComponentVillageStartPieceDune, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(par3, par4, par5, 0, 0, 0, 9, 7, 12, par6);
        return canVillageGoDeeper(var8) && StructureComponent.findIntersecting(par1List, var8) == null ? new ComponentVillageDuneHouse3(par0ComponentVillageStartPieceDune, par7, par2Random, var8, par6) : null;
    }
