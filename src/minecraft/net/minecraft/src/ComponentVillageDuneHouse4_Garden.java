...
public class ComponentVillageDuneHouse4_Garden extends ComponentVillageDune
{
    private int averageGroundLevel = -1;
    private final boolean isRoofAccessible;

    public ComponentVillageDuneHouse4_Garden(ComponentVillageStartPieceDune par1ComponentVillageStartPieceDune, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public static ComponentVillageDuneHouse4_Garden func_74912_a(ComponentVillageStartPieceDune par0ComponentVillageStartPieceDune, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(par3, par4, par5, 0, 0, 0, 5, 6, 5, par6);
        return StructureComponent.findIntersecting(par1List, var8) != null ? null : new ComponentVillageDuneHouse4_Garden(par0ComponentVillageStartPieceDune, par7, par2Random, var8, par6);
    }
