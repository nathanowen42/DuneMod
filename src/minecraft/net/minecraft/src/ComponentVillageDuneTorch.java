...
public class ComponentVillageDuneTorch extends ComponentVillageDune
{
    private int averageGroundLevel = -1;

    public ComponentVillageDuneTorch(ComponentVillageStartPieceDune par1ComponentVillageStartPieceDune, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public static StructureBoundingBox func_74904_a(ComponentVillageStartPieceDune par0ComponentVillageStartPieceDune, List par1List, Random par2Random, int par3, int par4, int par5, int par6)
    {
