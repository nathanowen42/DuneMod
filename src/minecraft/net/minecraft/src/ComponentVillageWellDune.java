...
public class ComponentVillageWellDune extends ComponentVillageDune
{
    private final boolean field_74924_a = true;
    private int averageGroundLevel = -1;
    Random rand = new Random();

    public ComponentVillageWellDune(ComponentVillageStartPieceDune par1ComponentVillageStartPieceDune, int par2, Random par3Random, int par4, int par5)
    {
    ...
    {
        StructureVillagePiecesDune.getNextStructureComponentVillagePath((ComponentVillageStartPieceDune)par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 1, this.getComponentType());
        StructureVillagePiecesDune.getNextStructureComponentVillagePath((ComponentVillageStartPieceDune)par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 3, this.getComponentType());
        StructureVillagePiecesDune.getNextStructureComponentVillagePath((ComponentVillageStartPieceDune)par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, 2, this.getComponentType());
        StructureVillagePiecesDune.getNextStructureComponentVillagePath((ComponentVillageStartPieceDune)par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, 0, this.getComponentType());
    }
