    ...
    private void addDefaultEquipmentAndRecipies(int par1)
    {
        ...
        switch (this.getProfession())
        {
            ...
            case 2:
                ...
                int[] var4 = new int[] {Item.swordSteel.itemID, Item.swordDiamond.itemID, Item.plateSteel.itemID, Item.plateDiamond.itemID, Item.axeSteel.itemID, Item.axeDiamond.itemID, Item.pickaxeSteel.itemID, Item.pickaxeDiamond.itemID};
                int[] var5 = var4;
