...
public class ItemBinoculars extends Item
{
    ...
    {
    	mod_DuneMod.drawBinocularHUD = true;
    	ModLoader.getMinecraftInstance().gameSettings.smoothCamera = true;
    ...
    {
    	mod_DuneMod.drawBinocularHUD = false;
    	ModLoader.getMinecraftInstance().gameSettings.smoothCamera = false;
