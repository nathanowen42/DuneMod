...
public class RenderBlocks
{
    ...
    public boolean renderBlockRedstoneWire(Block par1Block, int par2, int par3, int par4)
    {
        ...
        boolean var23 = BlockRedstoneWire.canConnectRedstone(this.blockAccess, par2 - 1, par3, par4, 1) || !this.blockAccess.isBlockNormalCube(par2 - 1, par3, par4) && BlockRedstoneWire.canConnectRedstone(this.blockAccess, par2 - 1, par3 - 1, par4, -1);
        boolean var24 = BlockRedstoneWire.canConnectRedstone(this.blockAccess, par2 + 1, par3, par4, 3) || !this.blockAccess.isBlockNormalCube(par2 + 1, par3, par4) && BlockRedstoneWire.canConnectRedstone(this.blockAccess, par2 + 1, par3 - 1, par4, -1);
        boolean var25 = BlockRedstoneWire.canConnectRedstone(this.blockAccess, par2, par3, par4 - 1, 2) || !this.blockAccess.isBlockNormalCube(par2, par3, par4 - 1) && BlockRedstoneWire.canConnectRedstone(this.blockAccess, par2, par3 - 1, par4 - 1, -1);
        boolean var26 = BlockRedstoneWire.canConnectRedstone(this.blockAccess, par2, par3, par4 + 1, 0) || !this.blockAccess.isBlockNormalCube(par2, par3, par4 + 1) && BlockRedstoneWire.canConnectRedstone(this.blockAccess, par2, par3 - 1, par4 + 1, -1);
