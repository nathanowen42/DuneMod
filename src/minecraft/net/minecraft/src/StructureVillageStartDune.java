...
class StructureVillageStartDune extends StructureStart
{
    /** well ... thats what it does */
    private boolean hasMoreThanTwoComponents = false;

    public StructureVillageStartDune(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ArrayList var6 = StructureVillagePiecesDune.getStructureVillageWeightedPieceList(par2Random, par5);
        ComponentVillageStartPieceDune var7 = new ComponentVillageStartPieceDune(par1World.getWorldChunkManager(), 0, par2Random, (par3 << 4) + 2, (par4 << 4) + 2, var6, par5);
        ...
        while (var13.hasNext())
        {
            ...
            if (!(var12 instanceof ComponentVillageRoadPieceDune))
            {
                ++var10;
            }
        }
