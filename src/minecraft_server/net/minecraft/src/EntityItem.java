...
public class EntityItem extends Entity
{
    ...
    public EntityItem(World par1World, double par2, double par4, double par6, ItemStack par8ItemStack)
    {
        ...
        this.setEntityItem(par8ItemStack);
    }
    ...
    public boolean combineItems(EntityItem par1EntityItem)
    {
        ...
        else if (par1EntityItem.isEntityAlive() && this.isEntityAlive())
        {
            ...
            else
            {
                ...
                par1EntityItem.setEntityItem(var3);
                this.setDead();
                return true;
            }
        }
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        this.setEntityItem(ItemStack.loadItemStackFromNBT(var2));
    ...
    /**
     * Sets the ItemStack corresponding to this Entity (and updates the DataWatcher for it)
     */
    public void setEntityItem(ItemStack par1ItemStack)
    {
