...
public class NetServerHandler extends NetHandler
{
    ...
    public void handleBlockDig(Packet14BlockDig par1Packet14BlockDig)
    {
        ...
        else
        {
            ...
            int var10 = MathHelper.abs(var6 - var17.posX);
            int var18 = MathHelper.abs(var8 - var17.posZ);
            ...
            if (par1Packet14BlockDig.status == 0)
            {
                if (var18 <= var3 && !var4)
                {
                    this.playerEntity.playerNetServerHandler.sendPacket(new Packet53BlockChange(var6, var7, var8, var2));
                }
                else
                {
            ...
            {
                this.playerEntity.theItemInWorldManager.blockRemoving(var6, var7, var8);
    ...
    public void handlePlace(Packet15Place par1Packet15Place)
    {
        ...
        else
        {
            ...
            int var12 = MathHelper.abs(var5 - var11.posX);
            int var13 = MathHelper.abs(var7 - var11.posZ);
        ...
        if (var3 == null || var3.getMaxItemUseDuration() == 0)
        {
            ...
            {
                this.sendPacket(new Packet103SetSlot(this.playerEntity.openContainer.windowId, var14.slotNumber, this.playerEntity.inventory.getCurrentItem()));
            }
        }
    }
